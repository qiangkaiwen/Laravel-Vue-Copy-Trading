    ...
    <div :class="[colClasses, { 'flex': colClasses}]">
        <fullscreen ref="fullscreen">
            <div class="app-card" :class="[customClasses, { 'd-none': close }]">
                <app-card-heading :heading="heading" :closeable="closeable" :reloadable="reloadable"
                    :fullScreen="fullScreen" :withTabs="withTabs" :tabs="tabs" @onChangeTabCallback="onChangeTab"
                    @onCollapse="onCollapse" @onReload="onReload" @onClose="onClose">
                </app-card-heading>
