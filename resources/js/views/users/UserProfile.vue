									...
									<div class="text-center">
										...
										<div class="social-list clearfix mb-5">
											<ul class="list-inline d-inline-block">
												<li><a href="javascript:void(0);" class="pink--text"><i
				...
				<v-dialog v-model="open" max-width="600">
					<v-card class="pa-6">
						...
						<v-card-actions class="pa-0">
							...
							<v-btn color="error" @click="editUser" class="px-4">Update</v-btn>
						</v-card-actions>
					</v-card>
				</v-dialog>
			</template>
...
<script>
	...
	export default {
		...
		mounted() {
			this.loading = true;
			webServices.get(`/users/${this.user_id}`, { headers: { 'Content-Type': 'application/json' } })
				.then(({ data }) => {
